-- v_companies_summary — Super Admin companies list (run once in Supabase SQL Editor)
-- Fixes: PGRST205 Could not find table public.v_companies_summary
...
SELECT 'v_companies_summary created' AS ok, COUNT(*) AS rows FROM v_companies_summary;
