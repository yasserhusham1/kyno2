-- 094 — خصم التأخير بنسبة الراتب اليومي ÷ دقائق الدوام الرسمية
-- يُحتسب فقط عند وجود حضور وانصراف معاً، ولا يُطبّق على دوام مفتوح.
...
REVOKE ALL ON FUNCTION saas_v3_employee_work_minutes(TIME, TIME, INTEGER) FROM PUBLIC;
GRANT EXECUTE ON FUNCTION saas_v3_employee_work_minutes(TIME, TIME, INTEGER) TO authenticated;
