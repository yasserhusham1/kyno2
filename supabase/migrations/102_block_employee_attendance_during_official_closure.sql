-- 102 — منع الحضور والانصراف للموظفين أثناء التعطيل الرسمي
-- يكمل 101: الموظف المسجل مسبقاً لا يستطيع تسجيل حضور/انصراف خلال العطلة.

-- PostgreSQL يرفض CREATE OR REPLACE إذا تغيّرت DEFAULTs للباراميترات؛ نحذف كل التوقيعات المعروفة أولاً.
