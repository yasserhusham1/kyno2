-- 099 — خصم الغياب للأيام المكتملة فقط
-- يحسب الغياب التلقائي حتى يوم أمس، ويعتمد الحضور + الانصراف لكل الحالات.
...
BEGIN
  ...
  -- لا نخصم يوم اليوم الحالي حتى يكتمل اليوم. يبدأ الخصم عند اليوم التالي.
