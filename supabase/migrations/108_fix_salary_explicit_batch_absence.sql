-- 108 — احتساب الغياب المُدخل يدوياً (دفعة) لكامل الفترة وليس الأيام المكتملة فقط
-- عند إضافة 26 يوم غياب في دفعة، يُخصم كل يوم غياب صريح ضمن الفترة
-- حتى الأيام المستقبلية داخل الشهر. الغياب التلقائي يبقى للأيام المكتملة بدون سجل.
...
BEGIN
  ...
  -- غياب صريح مُدخل للأيام المتبقية داخل الفترة (دفعة إدارية)
