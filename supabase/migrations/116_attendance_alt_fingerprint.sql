-- 116 — حضور/انصراف: قبول بصمات المتصفحات البديلة (يتطلب 115)

-- ============================================================
-- saas_upsert_attendance_by_device — فحص الجهاز عبر alt_fingerprints
-- ============================================================
...
BEGIN
  ...
  ELSIF fp IS NOT NULL AND length(fp) >= 8 THEN
    dev_ok := saas_device_fingerprint_matches(p_employee_id, fp, NULL);
  END IF;
